...
export default {
  ...
  computed: {
    ...
    menuItems() {
      return [
        {
          name: this.getTranslations.guide || "{ guide }",
          route: "/regions/guide",
        },
        {
          name: this.getTranslations.information || "{ information }",
          route: "/regions/info",
        },
        {
          name: this.getTranslations.contacts || "{ contacts }",
          route: "/regions/regions-contacts",
        },
      ];
    },
  },
...
<template>
  <div class="main-region">
    <side-bar
      class="side"
      :title="getTranslations.regions_side || '{ regions_side }'"
    />
    <div class="content">
      <sections>
        <template #title>
