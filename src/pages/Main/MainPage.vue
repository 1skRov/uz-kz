...
<template>
  <div class="main">
    <div class="sections">
      <section1
        :title="getTranslations.main_title"
        :btn_title="getTranslations.join_button"
        :isBackground="activeSection === 'section1'"
      />
      <section2
        :title="getTranslations.about_us"
        :btn_title="getTranslations.more_detail"
        :isBackground="activeSection === 'section2'"
      />
      <section3
        :title="getTranslations.culture_traditions"
        :btn_title="getTranslations.learn_more"
        :isBackground="activeSection === 'section3'"
      />
      <section4
        :title="getTranslations.popular_persons"
        :btn_title="getTranslations.learn_more"
        :isBackground="activeSection === 'section4'"
      />
      <section5
        :title="getTranslations.ethno_center"
        :btn_title="getTranslations.learn_more"
        :isBackground="activeSection === 'section5'"
      />
      <section6
        :title="getTranslations.partners"
        :isBackground="activeSection === 'section6'"
      />
    </div>
  </div>
</template>
