...
export default {
  name: "NewsDetail",
  components: { LatestNews, SwiperSlide, BasicButton },
  props: {
    id: {
      type: String,
      required: true,
    ...
    <div class="news-body">
      <div class="news-item">
        <div class="news-cover">
          <img
            :src="BASE_URL + news_item.image"
            :alt="BASE_URL + news_item.image"
          />
        </div>
      ...
      <div class="tablet-form">
        <LatestNews :title="getTranslations.latest_news"></LatestNews>
      </div>
    </div>
  </div>
</template>
