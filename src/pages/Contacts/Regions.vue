...
<template>
  <div class="contacts">
    ...
    <div class="left">
      ...
      <a class="left__mail" :href="`mailto:${contacts.email}`" target="_blank" style="text-decoration: none; color: #333333">
