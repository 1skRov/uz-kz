...
<template>
  <div class="contacts">
    <div class="map-mobile" v-if="isMobile">
      <map-component :latitude="contacts?.latitude ? Number(contacts.latitude) : 0"
                     :longitude="contacts?.longitude ? Number(contacts.longitude) : 0"/>
    </div>
    <div class="left">
      ...
      <div class="left__soc_media">
        ...
        <div style="display: flex; gap: 1.5rem">
          ...
          <a :href="contacts?.instagram" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          <a :href="contacts?.telegram" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          <a :href="contacts?.youtube" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          <a :href="contacts?.tiktok" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
