...
export default defineComponent({
  name: "regions",
  components: {SelectElement, MapComponent},
  data() {
    return {
      contacts: {
        phone1: null,
...
<template>
  <div class="contacts">
    ...
    <div class="left">
      ...
      <a class="left__mail" :href="`mailto:${contacts.email}`" target="_blank"
      ...
      <div class="left__soc_media">
        <p class="font-gilroy left__media-title">{{ getTranslations.social_media || "{ social_media }" }}</p>
        <div style="display: flex; gap: 1.5rem">
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_248_4912)">
              <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M13.875 23.8544C19.6118 22.9542 24 17.9896 24 12C24 5.37258 18.6274 0 12 0C5.37258 0 0 5.37258 0 12C0 17.9896 4.38819 22.9542 10.125 23.8544V15.4688H7.07812V12H10.125V9.35625C10.125 6.34922 11.9156 4.6875 14.6578 4.6875C15.9703 4.6875 17.3438 4.92188 17.3438 4.92188V7.875H15.8297C14.3391 7.875 13.875 8.80078 13.875 9.75V12H17.2031L16.6711 15.4688H13.875V23.8544Z"
                    fill="#0072AB"/>
            </g>
            <defs>
